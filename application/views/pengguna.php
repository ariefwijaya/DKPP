          ...
          <div class="row">
                ...
                <div class="box-body box-profile">
                  ...
                  <ul class="list-group list-group-unbordered">
                    <li class="list-group-item">
						<?php foreach($v_t->result_array() as $t)?>
                      <b>Total Solusi dan Masalah</b> <a class="pull-right"><?php echo $t['v_t'];?></a>
                    </li>
                    <li class="list-group-item">
						<?php foreach($v_e->result_array() as $e)?>
                    ...
                    <li class="list-group-item">
					  ...
					  <?php if($user['hak_akses']=='2'){ echo "Manager";}?>
			...
			<!-- About Me Box -->
              <div class="box box-primary">
                ...
                <div class="box-body">
                  <strong><i class="fa fa-certificate margin-r-5"></i>  No Badge</strong>
                  <p class="text-muted">
                    <?php echo $user['no_badge'];?>
                  </p>
