        ...
        <section class="content">
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <div class="box box-primary">
                <div class="box-header with-border">
                  <h3 class="box-title">Daftar User yang Anda Bagikan</h3>
                              ...
                              <br></br>
                                  <form method="post" action="<?php echo base_url('web/tambah_tag_explicit/'.$id_explicit);?>" enctype="multipart/form-data"> 
              ...
              <!------ MODAL FOR EDIT TAG EXPLICIT KNOWLEDGE ------------!-->
              </div><!-- /.box -->
  ...
  <script type="text/javascript">
      function delete_tags(tags_id)
      {
        ...
        $.ajax({  
            type: "POST",  
            url: "<?php echo base_url('Web/Ajax_hapus_tags_explicit');?>",
            data: dataString,
