...
<?php foreach($solusi->result_array() as $data)?>
        ...
        <section class="content">
			<div class="row">
				<div class="col-xs-12">
					<div class="col-md-12">
						<form action="<?php echo base_url();?>web/update_solusi" method="post" enctype="multipart/form-data">
						<div class="box box-solid box-default">
							...
							<?php foreach($gejala_masalah->result_array() as $gm){
								...
								<tr>
									...
									<td width="10px">
										<form action="<?php echo base_url();?>web/delete_gejala" method="post" enctype="multipart/form-data">
							...
							<?php }} ?>
								<tr>
									<form action="<?php echo base_url();?>web/tambah_gejala" method="post" enctype="multipart/form-data">
									<td colspan='2'>
